...
@patch("ai.auto_heal.agents.embedding_locator_healer.engine")
...
@patch("ai.auto_heal.agents.memory_updater.source_updater")
@patch("ai.auto_heal.agents.memory_updater.locator_store")
@patch("ai.auto_heal.agents.memory_updater.vector_store")
